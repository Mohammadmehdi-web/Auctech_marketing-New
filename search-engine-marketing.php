...
<body>
    ...
    <div class="service-details-page  body-black ">
        ...
        <div class="service-details-wcu pt-140 p-relative pb-140">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7 col-lg-7">
                        <div class="service-details-wcu-wrapper">
                            ...
                            <div class="service-details-wcu-title"
                                style="background-image: url(images/shape/service-details-pag-title-bg.png);">
                                <a href="#"><span class="icon-Arrow-2"></span></a>
                                <h3>Transforming Brands <span>Inspiring Audiences</span></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-5 col-lg-5">
                        ...
                        <div class="wcu-area-card-info-secondary">
                            ...
                            <div class="wcu-area-info-card-wrapper">
                                <span class="mb-15 fs-5 fw-bold">Our Key Services</span>
                                <p class="mt-4">
                        ...
                        <div class="">
                            <div class="wcu-area-info-card-wrapper">
                                ...
                                <p class="mt-4">
                                    <img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png" />
                                    <strong class="text-white"> Instant Visibility: </strong> Paid ads are displayed at the top or bottom of search results, making your brand highly noticeable.
                                </p>
                                <p class="mt-3">
                                    <img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png" />
                                    <strong class="text-white"> Targeted Reach: </strong> You can target specific audiences based on their location, age, interests, and browsing behavior.
                                </p>
                                <p class="mt-3">
                                    <img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png" />
                                    <strong class="text-white"> Keyword Relevance: </strong> Paid ads are triggered by specific keywords that match what users are searching for.
                                </p>
                                
                                <p class="mt-3">
                                    <img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png" />
                                    <strong class="text-white"> Remarketing Opportunities: </strong> Reach users who have previously visited your website but didn’t make a purchase.
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="our-work-step pb-140">
            <div class="container">
                <div class="section-title mb-60 style-1">
                    ...
                    <h2 class="mb-40 text-center">Our Services</h2>
                </div>
                <div class="row wrap">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="our-work-step-card-wrapper">
                            <div class="our-work-step-card-title">
                                <h4 style="margin-left:-40px">Corporate Branding</h4>
                                <p class="mb-3"><img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png"
                                        class="mr-2" /> Logo and Visual Identity Design.</p>
                                <p class="mb-3"><img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png"
                                        class="mr-2" /> Tagline and Brand Messaging Creation.</p>
                                <p class="mb-2"><img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png"
                                        class="mr-2" /> Brand Guidelines for Consistency.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="our-work-step-card-wrapper">
                            <div class="our-work-step-card-title">
                                ...
                                <h4 style="margin-left:-97px">Media Strategy</h4>
                                <p class="mb-3"><img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png"
                                        class="mr-2" /> Multi-Channel PR Campaigns.</p>
                                <p class="mb-3"><img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png"
                                        class="mr-2" /> Press Releases and Media Outreach.</p>
                                <p class="mb-2"><img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png"
                                        class="mr-2" /> Content Creation for Digital Platforms.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="our-work-step-card-wrapper">
                            <div class="our-work-step-card-title">
                                ...
                                <p class="mb-3"><img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png"
                                        class="mr-2" /> Online Reputation Monitoring.</p>
                                <p class="mb-3"><img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png"
                                        class="mr-2" /> Responding to Reviews and Feedback.</p>
                                <p class="mb-2"><img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png"
                                        class="mr-2" /> Crisis Communication Support.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="wcu-area body-black p-relative pb-140 ">
            <div class="container">
                <div class="section-title mb-60 style-1">
                    <span class="pb-15">Case Studies<img src="images/icon/section-title-arrow.svg" alt=""></span>
                    <h2>Case Studies</h2>
                </div>
                <div class="row ">
                    <div class="col-xl-8">
                        <div class="wcu-area-card-info">
                            <div class="wcu-area-info-card-wrapper">
                                <h5>Case Study 1: Tech Startup Branding</h5>
                                <div class="title-border-3 mt-30 mb-30"></div>
                                <p class="mb-2"><img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png"
                                        class="mr-2" /><strong class="text-white">Client: </strong> AI Support Platform
                                </p>
                                <p class="mb-2"><img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png"
                                        class="mr-2" /><strong class="text-white">Problem: </strong> No brand
                                    recognition.</p>
                                <p class="mb-2"><img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png"
                                        class="mr-2" /><strong class="text-white">Solution: </strong> Created a modern
                                    logo, tagline, and brand guidelines.</p>
                                <p class="mb-2"><img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png"
                                        class="mr-2" /><strong class="text-white">Result: </strong> 60% more brand
                                    visibility and increased investor interest.</p>
                            </div>
                            <div class="wcu-area-info-card-wrapper">
                                <h5>Case Study 2: Fashion Brand Promotion</h5>
                                <div class="title-border-3 mt-30 mb-30"></div>
                                <p class="mb-2"><img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png"
                                        class="mr-2" /><strong class="text-white">Client: </strong> Sustainable Clothing
                                    Brand.
                                </p>
                                <p class="mb-2"><img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png"
                                        class="mr-2" /><strong class="text-white">Problem: </strong> Low online
                                    presence.</p>
                                <p class="mb-2"><img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png"
                                        class="mr-2" /><strong class="text-white">Solution: </strong> Launched a social
                                    media campaign with influencers.</p>
                                <p class="mb-2"><img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png"
                                        class="mr-2" /><strong class="text-white">Result: </strong> 70% more social
                                    media followers and 40% higher sales.</p>
                            </div>

                            <div class="wcu-area-info-card-wrapper">
                                <h5>Case Study 3: Hotel Reputation Management</h5>
                                <div class="title-border-3 mt-30 mb-30"></div>
                                <p class="mb-2"><img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png"
                                        class="mr-2" /><strong class="text-white">Client: </strong> National Hotel
                                    Chain.
                                </p>
                                <p class="mb-2"><img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png"
                                        class="mr-2" /><strong class="text-white">Problem: </strong> Negative online
                                    reviews.</p>
                                <p class="mb-2"><img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png"
                                        class="mr-2" /><strong class="text-white">Solution: </strong> Managed feedback
                                    and enhanced service.</p>
                                <p class="mb-2"><img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png"
                                        class="mr-2" /><strong class="text-white">Result: </strong> Ratings rose to 4.6
                                    stars, boosting bookings by 35%.</p>
                            </div>

                            <div class="wcu-area-info-card-wrapper">
                                <h5>Case Study 4: Grocery Store Rebranding</h5>
                                <div class="title-border-3 mt-30 mb-30"></div>
                                <p class="mb-2"><img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png"
                                        class="mr-2" /><strong class="text-white">Client: </strong> Local Grocery Chain.
                                </p>
                                <p class="mb-2"><img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png"
                                        class="mr-2" /><strong class="text-white">Problem: </strong> Outdated brand
                                    image.</p>
                                <p class="mb-2"><img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png"
                                        class="mr-2" /><strong class="text-white">Solution: </strong> Made a new logo
                                    and did local marketing.</p>
                                <p class="mb-2"><img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png"
                                        class="mr-2" /><strong class="text-white">Result: </strong> 25% more customers
                                    and good community feedback.</p>
                            </div>
